...
export function EddieHome() {
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden bg-[#06091a]">
      {/* Background flies up into place once the loading bar finishes. */}
      <HomeBackdrop className="intro-flyup" />
      ...
      {/* Self-portrait — its bottom-right corner sits in the bottom-right corner of the
          screen. Blinks in only after the social icons finish (intro-blink-2 is delayed). */}
